...
**FallPhysio · sovereign single-file UK physiotherapy OS** — sovereign SDK extracted from `fallphysio/index.html`.

## Install
```bash
npm install @ai-native-solutions/fallphysio-sdk
```

## Use
```js
import * as fallphysio from '@ai-native-solutions/fallphysio-sdk';
```

- Playground: https://sjgant80-hub.github.io/fallphysio-sdk/
- MCP wrapper: [`@ai-native-solutions/fallphysio-mcp`](https://github.com/sjgant80-hub/fallphysio-mcp)
- HTTP API: [`@ai-native-solutions/fallphysio-api`](https://github.com/sjgant80-hub/fallphysio-api)
...
- **Discoverable** — indexed on the FallMarket catalog at [sjgant80-hub.github.io/fallmarket/listing.html?id=fallphysio-sdk](https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallphysio-sdk)
...
- **Companion SDK** (`npm install @ai-native-solutions/fallphysio-sdk-sdk`) — programmatic JavaScript API for direct integration.
- **Companion MCP server** (`claude mcp add fallphysio-sdk -- npx -y @ai-native-solutions/fallphysio-sdk-mcp`) — Model Context Protocol server that any Claude/Cursor/Codex client can invoke as a tool.
- **Companion HTTP API** (`docker run --rm ghcr.io/sjgant80-hub/fallphysio-sdk-api`) — containerized REST endpoint for language-agnostic access.
...
- **Registry entry**: https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallphysio-sdk
- **Live URL**: https://sjgant80-hub.github.io/fallphysio-sdk/
- **Source**: https://github.com/sjgant80-hub/fallphysio-sdk
